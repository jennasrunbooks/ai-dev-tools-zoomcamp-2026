...
//
// Every network call the app makes goes through the `waitlistApi` object
// below, whose method signatures mirror the endpoints in
// docs/spec.md section 4.1 / the eventual openapi.yaml. Today it's backed by
// an in-memory mock store; swapping in a real HTTP client later means
// rewriting the bodies of these functions only — nothing else in the app
